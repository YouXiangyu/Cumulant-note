...
- `src/api.ts`：封装 Tauri commands，暴露受控导入、收集箱 listener、MiMo 状态、抽取、整理计划、worker、resident worker、queue 单项/批量恢复、移动、单项/批量回滚、audit timeline、冲突详情/预览、冲突规则管理和 RAG 命令。
